...
WhitneyGroup:
	...
	db 18, AIPOM,      DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 18, TEDDIURSA,  DOUBLESLAP, MIMIC, ENCORE, METRONOME
...
BugsyGroup:
	...
	db 14, BUTTERFREE, TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 14, BEEDRILL,   POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
...
PryceGroup:
	...
	db 27, DELIBIRD,   HEADBUTT, ICY_WIND, AURORA_BEAM, REST
...
JasmineGroup:
	...
	db 30, FORRETRESS, THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
...
ChuckGroup:
	...
	db 27, LEDIAN,     LEER, RAGE, KARATE_CHOP, FURY_SWIPES
...
ClairGroup:
	...
	db 37, GYARADOS,   THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 37, LAPRAS,     THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
...
WillGroup:
	...
	db 40, GIRAFARIG,  QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 41, JYNX,       DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 41, SLOWKING,   CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
...
BrunoGroup:
	...
	db 43, HERACROSS,  BIND, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
...
KarenGroup:
	...
	db 42, SNEASEL,    STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 45, HOUNDOOM,   LICK, SPITE, CURSE, DESTINY_BOND
	db 44, MURKROW,    QUICK_ATTACK, WHIRLWIND, PURSUIT, FAINT_ATTACK
	db 47, TYRANITAR,  ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db -1 ; end
...
KogaGroup:
	...
	db 41, VICTREEBEL, SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 43, SCIZOR,     PROTECT, SWIFT, EXPLOSION, SPIKES
...
ChampionGroup:
	...
	db 47, STEELIX,    THUNDER_WAVE, TWISTER, THUNDER, HYPER_BEAM
	db 47, KINGDRA,    THUNDER_WAVE, TWISTER, BLIZZARD, HYPER_BEAM
...
BrockGroup:
	...
	db 41, SUDOWOODO,  DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 41, RHYDON,     FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 42, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, GOLEM,      BIND, ROCK_SLIDE, BIDE, SANDSTORM
...
MistyGroup:
	...
	db 42, POLITOED,   SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
...
LtSurgeGroup:
	...
	db 40, AMPHAROS,   SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
...
ErikaGroup:
	...
	db 42, SUNFLORA,   VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
